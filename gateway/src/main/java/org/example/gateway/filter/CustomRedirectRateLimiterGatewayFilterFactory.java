...
@Component
public class CustomRedirectRateLimiterGatewayFilterFactory extends
	AbstractGatewayFilterFactory<CustomRedirectRateLimiterGatewayFilterFactory.Config> {
	...
	public CustomRedirectRateLimiterGatewayFilterFactory(RateLimiter defaultRateLimiter, KeyResolver defaultKeyResolver) {
		super(Config.class);
